...
class GlowingMaterial extends ShaderMaterial {
  /**
  ...
  set color(newValue) {
    this.uniforms.glowColor.value.copy(newValue);
  }

  get falloff() {
    return this.uniforms.falloff.value;
  }

  set falloff(newValue) {
    this.uniforms.falloff.value = newValue;
  }

  get internalRadius() {
    return this.uniforms.glowInternalRadius.value;
  }

  set internalRadius(newValue) {
    this.uniforms.glowInternalRadius.value = newValue;
  }

  get sharpness() {
    return this.uniforms.glowSharpness.value;
  }

  set sharpness(newValue) {
    this.uniforms.glowSharpness.value = newValue;
  }
}
