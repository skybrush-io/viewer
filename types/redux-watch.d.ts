// This typing is similar to @types/redux-watch but better (more precise)
...
declare module 'redux-watch' {
   ...
   */
  type ChangeHandlerWrapper<T> = (changeHandler: ChangeHandler<T>) => Disposer;
   ...
   */
  function watch<T = unknown, S = unknown>(
    getState: () => S,
    pathToField?: FieldPath,
